...
pub fn element(scanner: &mut Scanner) -> Result<Option<Element>, Error> {
    Ok(scanner.scan(|symbol| match symbol {
        ...
        "Bh" => Some(Action::Return(Element::Bh)),
        ...
        "Cn" => Some(Action::Return(Element::Cn)),
        ...
        "Db" => Some(Action::Return(Element::Db)),
        "Ds" => Some(Action::Return(Element::Ds)),
        ...
        "Fl" => Some(Action::Return(Element::Fl)),
        ...
        "Hs" => Some(Action::Return(Element::Hs)),
        ...
        "Nh" => Some(Action::Return(Element::Nh)),
        ...
        "Og" => Some(Action::Return(Element::Og)),
        ...
        "Rg" => Some(Action::Return(Element::Rg)),
        ...
        "Sg" => Some(Action::Return(Element::Sg)),
        ...
        "Ts" => Some(Action::Return(Element::Ts)),
